...
module AspaceFormHelper
    ...
    class FormContext
        ...
        def label_and_fourpartid
            field_html = (@active_template == 'accession') ? select('id_0', {:ACQ => 'ACQ'}, {:type => 'data-combobox', :size => 1}) : select('id_0', {:ARCH => 'ARCH', :COLL=>'COLL'},{:type => 'data-combobox', :size => 1})
            field_html << textfield("id_1", obj["id_1"], {:class => "id_1 form-control", :size => 16, :disabled => false, :'aria-label' => "id_1", :placeholder => 'Make new id', :readonly => true, :title=>'Make new id' })
            field_html << textfield("id_2", obj["id_2"], {:class => "id_2 form-control", :size => 10, :disabled => true, :'aria-label' => "id_2"})
            field_html << textfield("id_3", obj["id_3"], {:class => "id_3 form-control", :size => 10, :disabled => true, :'aria-label' => "id_3"})
